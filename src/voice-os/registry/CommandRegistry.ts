...
CommandRegistry.registerPage({
  ...
  commands: [
    ...
    },
    {
      ...
      page: 'doctor',
      category: 'action',
      triggers: ['call nurse', 'message nurse', 'contact nurse'],
...
CommandRegistry.registerPage({
  ...
  commands: [
    ...([
      { tab: 'ward', triggers: ['ward', 'ward beds', 'patient ward'] },
      { tab: 'vitals', triggers: ['vitals', 'vital signs', 'record vitals'] },
      { tab: 'tasks', triggers: ['tasks', 'nursing tasks', 'task list'] },
      { tab: 'meds', triggers: ['medication', 'meds tab', 'administer meds'] },
      { tab: 'handover', triggers: ['handover', 'shift handover', 'shift report'] },
      { tab: 'messages', triggers: ['messages', 'nurse messages'] },
      { tab: 'inventory', triggers: ['inventory', 'stock', 'supplies'] },
    ] as const).map(t => ({
      id: `nurse-tab-${t.tab}`,
      page: 'nurse',
      category: 'navigation',
    ...
    })),
    {
      ...
      page: 'nurse',
      category: 'action',
      triggers: ['save vitals', 'confirm vitals', 'submit vitals'],
    ...
    },
    {
      ...
      page: 'nurse',
      category: 'action',
      triggers: ['medication given', 'confirm medication', 'verify med', 'administer'],
    ...
    },
    {
      ...
      page: 'nurse',
      category: 'action',
      triggers: ['transfer to icu', 'icu transfer', 'shift to icu'],
    ...
    },
    {
      ...
      page: 'nurse',
      category: 'action',
      triggers: ['code blue', 'sos', 'cardiac arrest', 'call doctor emergency'],
...
CommandRegistry.registerPage({
  ...
  commands: [
    ...([
      { tab: 'home', triggers: ['go to home', 'open home', 'home screen'] },
      { tab: 'records', triggers: ['go to records', 'medical records', 'my records', 'view records'] },
      { tab: 'wallet', triggers: ['go to wallet', 'my wallet', 'check balance'] },
      { tab: 'sos', triggers: ['go to emergency', 'sos tab', 'emergency call'] },
      { tab: 'profile', triggers: ['go to profile', 'my profile', 'settings'] },
    ] as const).map(t => ({
    ...
    })),
    {
      ...
      page: 'patient',
      category: 'action',
      triggers: ['book appointment', 'book opd', 'new booking'],
    ...
    },
    {
      ...
      page: 'patient',
      category: 'action',
      triggers: ['start consult', 'video consult', 'call doctor'],
    ...
    },
    {
      ...
      page: 'patient',
      category: 'action',
      triggers: ['view abha', 'show abha', 'abha card', 'digital health card'],
