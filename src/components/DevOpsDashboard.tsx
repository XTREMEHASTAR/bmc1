...
export default function DevOpsDashboard({
  ...
  return (
    <div className={`min-h-screen font-sans ${isDarkMode ? 'bg-[#09090e] text-gray-100' : 'bg-slate-50 text-slate-800'} transition-all`}>
      {/* Devops Header Panel */}
      <header className="sticky top-0 z-40 border-b p-4 backdrop-blur-md flex items-center justify-between transition-colors bg-white/95 border-gray-150 dark:bg-[#0c0c12]/95 dark:border-gray-900">
      ...
      <div className="p-4 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white dark:bg-[#12121a] border border-gray-150 dark:border-gray-850 rounded-2xl p-4 shadow-sm flex flex-col justify-between">
            <span className="text-[9px] font-black uppercase tracking-wider text-gray-450">Kubernetes Node Status</span>
          ...
          <div className="bg-white dark:bg-[#12121a] border border-gray-150 dark:border-gray-850 rounded-2xl p-4 shadow-sm flex flex-col justify-between">
            <span className="text-[9px] font-black uppercase tracking-wider text-gray-450">Active Database Replicas</span>
          ...
          <div className="bg-white dark:bg-[#12121a] border border-gray-150 dark:border-gray-850 rounded-2xl p-4 shadow-sm flex flex-col justify-between">
            <span className="text-[9px] font-black uppercase tracking-wider text-gray-450">Region Availability</span>
          ...
          <div className="bg-white dark:bg-[#12121a] border border-gray-150 dark:border-gray-850 rounded-2xl p-4 shadow-sm flex flex-col justify-between">
            <span className="text-[9px] font-black uppercase tracking-wider text-gray-450">SRE Error Budget Remaining</span>
        ...
        <div className="flex flex-wrap gap-1.5 p-1 bg-white dark:bg-[#12121a] border border-gray-150 dark:border-gray-850 rounded-2xl max-w-6xl shadow-sm">
          {[
          ...
          <AnimatePresence mode="wait">
            ...
            {activeSection === 'infrastructure' && (
              ...
              >
                ...
                <div className="lg:col-span-2 bg-white dark:bg-[#12121a] border border-gray-150 dark:border-gray-850 rounded-3xl p-5 shadow-sm space-y-4">
                ...
                <div className="bg-white dark:bg-[#12121a] border border-gray-150 dark:border-gray-850 rounded-3xl p-5 shadow-sm space-y-4">
                ...
                <div className="bg-white dark:bg-[#12121a] border border-gray-150 dark:border-gray-850 rounded-3xl p-5 shadow-sm space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-semibold">
                    <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-2xl space-y-1">
                      <p className="text-[10px] text-gray-450 uppercase">Availability Target</p>
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-2xl space-y-1">
                      <p className="text-[10px] text-gray-450 uppercase">Latency Target (P99)</p>
                      <h4 className="text-lg font-black text-rose-500">&lt; 150ms</h4>
                      <p className="text-[9.5px] text-emerald-500">Current P99: 42ms</p>
                    </div>

                    <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-gray-100 dark:border-gray-800 rounded-2xl space-y-1">
                      <p className="text-[10px] text-gray-450 uppercase">Remaining Error Budget</p>
